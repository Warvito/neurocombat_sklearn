...
project = u'neurocombat_sklearn'
copyright = u'2019, Walter Hugo Lopez Pinaya'
...
# from neurocombat_sklearn import __version__
version = '0.1'
# version = __version__
...
sphinx_gallery_conf = {
    'doc_module': 'neurocombat_sklearn',
    'backreferences_dir': os.path.join('generated'),
    'reference_url': {
        'neurocombat_sklearn': None}
}
